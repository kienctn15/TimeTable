...
public class GGWP extends AppCompatActivity implements
    ...
    public void onStart() {
        ...
        if (opr.isDone()) {
            ...
            Toast.makeText(GGWP.this, "AHihi vào rồi", Toast.LENGTH_SHORT).show();
            Intent i = new Intent(GGWP.this, MainActivity.class);
            startActivity(i);
